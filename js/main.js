...
function loadFooter(){
    ...
    if(authprovider == "password") {
        ...
        document.write("               <h3>Hi, " + ref.getAuth().facebook.displayName + ". You are logged in through Facebook.<\/h3> ");
    }
    else if(authprovider == "Google") {
        document.write("               <h3>Hi, " + ref.getAuth().google.displayName + ". You are logged in through Google.<\/h3> ");
    }
    document.write("            <\/section>");
